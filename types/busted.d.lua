...
-- ::: :/lua/types/busted.d.lua
--
--

---@meta

-- This is a type-only declaration file for lua_ls (never `require`d or
-- executed), so its intentional global declarations aren't real-code
-- bugs; .husky/pre-commit's lintfmt_lua() excludes types/*.d.lua from
-- the selene pass entirely for this reason.
