...
; Unordered lists
(unordered_list1
	(unordered_list1_prefix) @neorg.lists.unordered.1.prefix.norg
	content: (paragraph (paragraph_segment)) @neorg.lists.unordered.1.paragraph_segment.norg
)
(unordered_list2
	(unordered_list2_prefix) @neorg.lists.unordered.2.prefix.norg
	content: (paragraph (paragraph_segment)) @neorg.lists.unordered.2.paragraph_segment.norg
)
(unordered_list3
	(unordered_list3_prefix) @neorg.lists.unordered.3.prefix.norg
	content: (paragraph (paragraph_segment)) @neorg.lists.unordered.3.paragraph_segment.norg
)
(unordered_list4
	(unordered_list4_prefix) @neorg.lists.unordered.4.prefix.norg
	content: (paragraph (paragraph_segment)) @neorg.lists.unordered.4.paragraph_segment.norg
)
(unordered_list5
	(unordered_list5_prefix) @neorg.lists.unordered.5.prefix.norg
	content: (paragraph (paragraph_segment)) @neorg.lists.unordered.5.paragraph_segment.norg
)
(unordered_list6
	(unordered_list6_prefix) @neorg.lists.unordered.6.prefix.norg
	content: (paragraph (paragraph_segment)) @neorg.lists.unordered.6.paragraph_segment.norg
)

; Ordered lists
(ordered_list1
	(ordered_list1_prefix) @neorg.lists.ordered.1.prefix.norg
	content: (paragraph (paragraph_segment)) @neorg.lists.ordered.1.paragraph_segment.norg
)
(ordered_list2
	(ordered_list2_prefix) @neorg.lists.ordered.2.prefix.norg
	content: (paragraph (paragraph_segment)) @neorg.lists.ordered.2.paragraph_segment.norg
)
(ordered_list3
	(ordered_list3_prefix) @neorg.lists.ordered.3.prefix.norg
	content: (paragraph (paragraph_segment)) @neorg.lists.ordered.3.paragraph_segment.norg
)
(ordered_list4
	(ordered_list4_prefix) @neorg.lists.ordered.4.prefix.norg
	content: (paragraph (paragraph_segment)) @neorg.lists.ordered.4.paragraph_segment.norg
)
(ordered_list5
	(ordered_list5_prefix) @neorg.lists.ordered.5.prefix.norg
	content: (paragraph (paragraph_segment)) @neorg.lists.ordered.5.paragraph_segment.norg
)
(ordered_list6
	(ordered_list6_prefix) @neorg.lists.ordered.6.prefix.norg
	content: (paragraph (paragraph_segment)) @neorg.lists.ordered.6.paragraph_segment.norg
)
