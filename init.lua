...
_G.setup_guard("util.lazy", {
    ...
    spec = {
        { import = "spec" },
        {
            ...
            import = function()
                return {
                    { cond = false, "folke/noice.nvim" },
                    { cond = false, "folke/snacks.nvim" },
                    { cond = false, "L3M0NAD3/LuaSnip" },
                    { cond = false, "mikavilpas/yazi.nvim" },
                    { cond = false, "stevearc/oil.nvim" },
                    { cond = false, "kndndrj/nvim-dbee" },
